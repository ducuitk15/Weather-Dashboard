...
subscribeButton.addEventListener('click', () => {
    ...
    if (email) {
        alert(`A confirmation email has been sent to ${email} to complete your subscription.`);
        // Add logic to handle email subscription via an API call.
    } else {
...
unsubscribeButton.addEventListener('click', () => {
    const email = emailField.value.trim();
    if (email) {
        alert(`A confirmation email has been sent to ${email} to complete your unsubscription.`);
        // Add logic to handle email unsubscription via an API call.
    } else {
        alert('Please enter a valid email address.');
    }
});
